...
```typescript
import { TranslateService } from '@kuhn/translate';
    ...
    providers: [
        {
            ...
            useFactory: (translateService: TranslateService) =>
                ({
                    maxSizeReached: translateService.translate(
                        27239,
                        'Maximum number of characters reached.'
                    ),
                    cannotDelete: translateService.translate(
                        27240,
                        'Cannot be deleted.'
                    ),
                    invalidNotation: translateService.translate(
                        27263,
                        'Unvalid notation.'
                    ),
                    unauthorizedChar: translateService.translate(
                        27238,
